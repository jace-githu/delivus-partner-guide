...
<section class="dg-section dg-policy-preview">
  <div class="dg-section-heading">
    <div>
      ...
      <p class="dg-section-lead">입고부터 배송·클레임까지, 필요한 기준을 바로 찾아보세요.</p>
    </div>
    <a class="dg-section-link" href="/policy/overview">전체 정책 안내</a>
  </div>
...
<section class="dg-section">
  ...
  <div class="dg-grid">
    ...
    <a class="dg-card" href="/cs/contact">
      ...
      <span class="dg-card-count">2개 문서</span>
    </a>
    <a class="dg-card" href="/notice/">
      <span class="dg-card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11l14-6v14L4 13v-2z"/><path d="M8 14v4a1 1 0 001 1h1"/></svg></span>
      <span class="dg-card-title">공지 · 개정이력</span>
      <span class="dg-card-desc">정책 변경 사항을 날짜별로 확인</span>
      <span class="dg-card-count">2개 문서</span>
    </a>
  </div>
</section>
